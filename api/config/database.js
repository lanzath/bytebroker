...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'lanza', 'lanzathm@gmail.com', 'secret', 'Lanza' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'lanza')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'pombo', 'pombo@bytebank.com', 'secret', 'Pombo' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'mario')
`;
